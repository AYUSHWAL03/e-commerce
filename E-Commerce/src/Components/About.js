...
const About = () => {
  return (
    <>
      ...
      <div className="about">
        <h2 className="text-success h2 mt-3">online grocery store</h2>
        <blockquote className="mt-2 content">
          ...
          of a button? Indias first comprehensive online megastore,
          ...
          your daily needs. bigbasket.com is convenience personified Weve taken
          ...
          that bigbasket- Indias largest online supermarket, has revolutionized
          the way India shops for groceries. Online grocery shopping has never
          been easier. Need things fresh? Whether its fruits and vegetables or
        ...
        <strong className="text-success mb-5"
        ...
        <blockquote className="mt-2 content">
          <ul>
            ...
            <li>
              ...
              your favorite neighborhood store for tonights party? Well
        ...
        <h2 className="text-success h2 mt-3">Indias biggest Online Supermarket</h2>
        <blockquote className="mt-2 content">
          ...
          for a no-questions-asked refund. Best quality products for our
          quality-conscious customers. onlinestore is synonymous with superior
          quality and continues to strive for higher levels of customer trust
          and confidence, by taking feedback and giving our customers what they
          want. We have added the convenience of pre-cut fruits in our Fresho
          range. If its a product category youre looking to shop from, weve
          made it convenient for you to access all products in a section easily.
          For instance, if youre looking for beverages, you can order from a
          ...
          farmers from whom we source our fresh products. Most of our farm-fresh
          products are sourced directly from farmers, which not only ensures the
          best prices and freshest products for our customers but also helps the
          ...
          compromising on quality, has made onlinestore the online supermarket
